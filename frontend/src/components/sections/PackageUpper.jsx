  ...
  return (
    <div className="mt-24">
      <div className="flex flex-col gap-4 p-4 md:w-[800px] md:mx-auto">
        <div className="h-8 w-8 shadow rounded-full flex items-center justify-center bg-indigo-500 lg:h-14 lg:w-14">
          <FaThumbsUp className="text-white text-xl md:text-2xl" />
        </div>
